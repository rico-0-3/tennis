...
st.markdown("### La Battaglia dei Modelli")
...
try:
    ...
    st.error(" Risultati mancanti. Esegui prima `aggiorna_tutto.py`.")
    st.stop()
...
if os.path.exists(path_ann):
    ...
    st.warning(" Nessun dato di analisi disponibile. Esegui `comparar_modelos.py` o il training ANN.")